...
def main():
    ...
    """
    Below code promts user with a welcome message and user for the choice to select
    User get promots based on the nagivation through the choice
    
    """
    while True:
        print("Hello user, check for all the information on World of cats")
        print("Please choose options to Continue or tyoe exit to exit")
