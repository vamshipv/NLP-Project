...
class Generator:
    ...
    def generate_summary(self, user_query, review_list, aspects=None):
        """
        ...
        with open(log_path, "a", encoding="utf-8") as f:
            # <<< THIS IS THE FIX >>>
            # Removed the extra parenthesis before log_data
...
if __name__ == "__main__":
    ...
    summary2 = generator.generate_summary(user_query_2, sample_reviews, aspects=[])
    print("Generated Summary:\n", summary2)